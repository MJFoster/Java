...
//		return this.numOfPlays;
		return getTimesPlayed();  // Method from PlayableSong class derived from
	}


	/**
	 * METHOD REMOVED SINCE THIS SHOULD BE CALCULATED INTERNALLY.
...
//	/**  REMOVED METHOD ... USING 'play()' & 'stop()' FROM 'PlayableSong' CLASS!!!
//	 * Play the sound clip of current Song
...
//	}
	...
	public String toString()
	{
		if(fileName != "")
		{
			...
			return String.format("%-20s %-25s %-8s %-20s", title, artist, time, fileName );
		}
		else 
		{
			return "";

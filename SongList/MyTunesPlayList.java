...
public class MyTunesPlayList extends PlayList
{
	 ...
	 * Constructor derived from "PlayList" super constructor.
	 * @param file The file to load the song data from.
	 */
	public MyTunesPlayList(File file)
	{
		// Use constructor from PlayList.java
		super(file);
		this.playing = null;
	...
	{
		if(playing != null) {
			System.out.println("Play #: " + (playing.getNumOfPlays()+1) + " of " + playing.getTitle());
			playing.play();
		}
	}

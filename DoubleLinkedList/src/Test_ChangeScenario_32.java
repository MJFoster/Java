 ...
 * Tests for Change Scenario 32: [A,B,C] -> removeFirst() -> [B,C]
 * 
 * @Version Summer 2016
 * @author MaryJo Foster
 */
public class Test_ChangeScenario_32
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.B}, {TestCase.C} };
		...
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.B}, {1, TestCase.C} };

 ...
 * List Iterator Tests for Change Scenario 22: [A,B] -> addAfter(C,A) -> [A,C,B]
 * 
 * @author MaryJo Foster
 * @version summer 2016
 */
public class ListItrTest_ChangeScenario_22
{
	...
	private final Integer MIDDLE = TestCase.C;
	...
	//************************  LAST 3 METHODS TO INCLUDE  ***************************
	
	
	/*********Call next() 3x, and previous(), then run tests**********/
	/**
	 * Test: new ListIterator, call next() 3x, and previous(); test hasPrevious() - whether there's a previous element in the ListIterator list
	 * Expected Result: true
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and previous(); test previous() - returns ref to previous element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and previous(); test add() - adds new element to the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and previous(); test nextIndex() - index of next element in the ListIterator list
	 * Expected Result: 2
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and previous(); test previousIndex() - index of previous element in the ListIterator list
	 * Expected Result: 1
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and previous(); test set() - sets element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/*********Call next() 3x, previous(), and add(), then run tests**********/
	/**
	 * Test: new ListIterator, call next() 3x, previous(), and add(); test hasPrevious() - whether there's a previous element in the ListIterator list
	 * Expected Result: true
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, previous(), and add(); test previous() - returns ref to previous element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, previous(), and add(); test add() - adds new element to the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, previous(), and add(); test nextIndex() - index of next element in the ListIterator list
	 * Expected Result: 3
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, previous(), and add(); test previousIndex() - index of previous element in the ListIterator list
	 * Expected Result: 2
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, previous(), and add(); test set() - sets element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test(expectedExceptions = IllegalStateException.class)
	...
	/*********Call next() 3x, and add(), then run tests**********/
	/**
	 * Test: new ListIterator, call next() 3x, and add(); test hasPrevious() - whether there's a previous element in the ListIterator list
	 * Expected Result: true
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and add(); test previous() - returns ref to previous element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and add(); test add() - adds new element to the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and add(); test nextIndex() - index of next element in the ListIterator list
	 * Expected Result: 4, size of list currently
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and add(); test previousIndex() - index of previous element in the ListIterator list
	 * Expected Result: 3
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() 3x, and add(); test set() - sets element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test(expectedExceptions = IllegalStateException.class)

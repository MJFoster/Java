 ...
 * Iterator Tests for Change Scenario 22: [A, B] -> addAfter(C,A) -> [A, C, B]
 * 
 * @author MaryJo Foster
 * @version summer 2016
 */
public class ItrTest_ChangeScenario_22
{
	...
	private static final Integer MIDDLE = TestCase.C;
	 ...
	 * Expected Result: Reference to original middle element in list
	 */
	@Test
	...
	/*********Call next() two times, remove(), next(); then run tests**********/
	/**
	...
	/**
	 * Test: new Iterator, call next(), next(), remove(), next(); test remove() - tries to remove last element returned by next in the Iterator list
	 * Expected Result: no exception
	 */
	@Test

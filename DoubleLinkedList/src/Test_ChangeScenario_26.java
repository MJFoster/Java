 ...
 * Tests for Change Scenario 26: [A,B] -> set(0,C) -> [C,B]
 * 
 * @Version Summer 2016
 * @author MaryJo Foster
 */
public class Test_ChangeScenario_26
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.C}, {TestCase.B} };
		...
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.C}, {1, TestCase.B} };
	 ...
	 * Expected Result: Reference to first element (C) 
	 */
	@Test
	 ...
	 * Expected Result: Reference to last element (B)
	 */
	@Test

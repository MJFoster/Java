 ...
 * ListIterator Tests for Change Scenario 16: [A,B] -> remove(0) -> [B]
 * 
 * @author MaryJo Foster
 * @version summer 2016
 */
public class ListItrTest_ChangeScenario_24
{
	...
	// Element used in add method during initial state change
	private final Integer ADDED_ELEMENT = TestCase.E;
	// Element not in list - used for testing methods in this unit test

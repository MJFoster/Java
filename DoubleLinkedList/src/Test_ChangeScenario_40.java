 ...
 * Tests for Change Scenario 40: [A,B,C] -> set(0,D) -> [D,B,C]
 * 
 * @Version Summer 2016
 * @author MaryJo Foster
 */
public class Test_ChangeScenario_40
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.D}, {TestCase.B}, {TestCase.C} };
		...
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.D}, {1, TestCase.B}, {2, TestCase.C} };
	 ...
	 * Expected Result: Reference to first element (D) 
	 */
	@Test

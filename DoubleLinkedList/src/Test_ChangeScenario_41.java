 ...
 * Tests for Change Scenario 41: [A,B,C] -> set(1,D) -> [A,D,C]
 * 
 * @Version Summer 2016
 * @author MaryJo Foster
 */
public class Test_ChangeScenario_41
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.A}, {TestCase.D}, {TestCase.C} };
		...
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.A}, {1, TestCase.D}, {2, TestCase.C} };

 ...
 * Tests for Change Scenario 22: [A,B] -> addAfter(C,A) -> [A,C,B]
 * 
 * @Version Summer 2016
 * @author MaryJo Foster
 */
public class Test_ChangeScenario_22
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.A}, {TestCase.C}, {TestCase.B} };
		...
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.A}, {1, TestCase.C}, {2, TestCase.B} };

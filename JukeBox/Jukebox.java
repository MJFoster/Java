...
public class Jukebox
{
	...
	/**
	 * Reads song information from the user (via its own scanner) and
	 * creates a new Song object.
	 *
	 * @return The new song.
	 * @param scan : Scanner for standard input
	 */
	...
	{		
		...
		int time = Integer.parseInt(scan.nextLine().trim());

		System.out.print("Enter file: ");
		String fileName = scan.nextLine().trim();

		return new Song(title, artist, time, fileName);
	}
	 ...
	 * Song 2 File path
	 * etc.
	 * @param filename : The filename of a song clip datafile.
	 * @return A new playlist of Songs.
	 */
